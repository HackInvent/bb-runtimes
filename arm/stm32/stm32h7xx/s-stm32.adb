...
package body System.STM32 is
   ...
   begin
      case Source is
         ...
         when SYSCLK_SRC_PLL =>
            declare
               Pllm   : constant UInt32 := UInt32 (4);
               Plln   : constant UInt32 := UInt32 (400);
               Pllp   : constant UInt32 := UInt32 (2);
               Pllvco : UInt32;
      ...
      begin
         ...
         if RCC_Periph.CFGR.TIMPRE = 0 then
            --  Mode 0:
